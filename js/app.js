...
function createOrientationToggleButton() {
    ...
    // El contenedor está a la derecha, así que ajustamos el right para que sea adyacente.
    // Suponiendo un ancho del botón 3D de aprox 70px + espacios.
    btn.style.bottom = "172px"; 
